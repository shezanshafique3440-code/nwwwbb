...
(function () {
  ...
  const LOGO =
    ...
    '<path d="M22 26V19a10 10 0 0 1 20 0v7" stroke="#1E3A8A" stroke-width="3.4" stroke-linecap="round"/>' +
    '<path d="M14 40c8 4 14 5 20 3s12-5 20-3l-2.2 16a4 4 0 0 1-4 3.6H18A4 4 0 0 1 14 56z" fill="#22C55E" opacity=".85"/>' +
